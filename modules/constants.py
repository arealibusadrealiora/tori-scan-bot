# Conversation states
LANGUAGE, ITEM, CATEGORY, SUBCATEGORY, PRODUCT_CATEGORY, REGION, CITY, AREA, MORE_LOCATIONS, MORE_CATEGORIES, DEALER_SEGMENT, MAIN_MENU, SETTINGS_MENU, CONFIRMATION = range(14)
