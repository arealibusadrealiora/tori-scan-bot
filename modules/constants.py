# Conversation states
LANGUAGE, ITEM, CATEGORY, SUBCATEGORY, PRODUCT_CATEGORY, REGION, CITY, AREA, MORE_LOCATIONS, MORE_CATEGORIES, DEALER_SEGMENT, SHIPPING_TYPES, MAIN_MENU, SETTINGS_MENU, CONFIRMATION = range(15)
